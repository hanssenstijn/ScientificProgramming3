...
The discriptor calculation will here be done without parallel computing to determine how much is to gained by doing parallel computing.
```{r}
...
```{r}
# set the rownames to numbers so the dataframes will have similar names
rownames(descriptors_twoCore) <- c() 
rownames(descriptors_threeCore) <- c()
# test is there are differences between the dataframes.
